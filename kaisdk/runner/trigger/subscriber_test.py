...
from kaisdk.runner.trigger.exceptions import NewRequestMsgError
from kaisdk.runner.trigger.subscriber import TriggerSubscriber
...
@patch("kaisdk.runner.trigger.subscriber.getattr")
...
@patch("kaisdk.runner.trigger.subscriber.getattr", return_value=None)
...
@patch("kaisdk.runner.trigger.subscriber.uncompress", side_effect=Exception("Uncompress error"))
...
@patch("kaisdk.runner.trigger.subscriber.KaiNatsMessage", return_value=MockKaiNatsMessage())
