...
from kaisdk.runner.exit.exceptions import NewRequestMsgError
...
@patch("kaisdk.runner.exit.subscriber.uncompress", side_effect=Exception("Uncompress error"))
...
@patch("kaisdk.runner.exit.subscriber.KaiNatsMessage", return_value=MockKaiNatsMessage())
