...
from kaisdk.sdk.auth.authentication import Authentication
from kaisdk.sdk.model_registry.exceptions import (
...
from kaisdk.sdk.model_registry.model_registry import Model, ModelInfo, ModelRegistry, ModelRegistryABC
...
@patch("kaisdk.sdk.model_registry.model_registry.ModelRegistry._object_exist", return_value=False)
...
@patch("kaisdk.sdk.model_registry.model_registry.ModelRegistry.get_model", return_value=EXPECTED_MODEL)
...
@patch("kaisdk.sdk.model_registry.model_registry.ModelRegistry._object_exist", return_value=True)
...
@patch("kaisdk.sdk.model_registry.model_registry.ModelRegistry._object_exist", return_value=True)
@patch("kaisdk.sdk.model_registry.model_registry.ModelRegistry._get_model_version_from_list")
