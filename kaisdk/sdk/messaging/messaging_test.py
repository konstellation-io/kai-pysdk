...
from kaisdk.sdk.messaging.exceptions import FailedToGetMaxMessageSizeError, MessageTooLargeError, NewRequestMsgError
from kaisdk.sdk.messaging.messaging import Messaging, _message_type_converter
from kaisdk.sdk.messaging.messaging_utils import compress, is_compressed
...
@patch("kaisdk.sdk.messaging.messaging_utils.is_compressed", return_value=True)
@patch("kaisdk.sdk.messaging.messaging_utils.uncompress", return_value=Exception)
