...
from kaisdk.sdk.persistent_storage.exceptions import (
    FailedToDeleteFileError,
    FailedToGetFileError,
    FailedToInitializePersistentStorageError,
    FailedToSaveFileError,
)
from kaisdk.sdk.persistent_storage.persistent_storage import Object, ObjectInfo, PersistentStorage, PersistentStorageABC
...
@patch("kaisdk.sdk.persistent_storage.persistent_storage.PersistentStorage._object_exist", return_value=True)
...
@patch("kaisdk.sdk.persistent_storage.persistent_storage.PersistentStorage._object_exist", return_value=False)
